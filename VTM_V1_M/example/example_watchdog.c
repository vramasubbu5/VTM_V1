...
{
    s32* wtdid = (s32*)param;
    Ql_WTD_Feed(*wtdid);  //disable by amruta for testing
   // Ql_Timer_Stop(LOGIC_WTD1_TMR_ID);  // added by amruta for testing
    // Ql_Timer_Stop(LOGIC_WTD2_TMR_ID);  // added by amruta for testing
