...
typedef enum{
    URC_BT_NONE = 0,
    BT_ERROR_CODE_SCAN_FOUND,
    BT_ERROR_CODE_SCAN_FINISH,
    BT_ERROR_CODE_PAIR_REQ,
    BT_ERROR_CODE_PAIR_PINCODE,
    BT_ERROR_CODE_PAIR_NOPINCODE,
    BT_ERROR_CODE_PAIR_SUCCESS,
    BT_ERROR_CODE_PAIR_FAILED,
    BT_ERROR_CODE_CONN_REQ,
    BT_ERROR_CODE_CONN_SUCCESS,
    BT_ERROR_CODE_CONN_FAILED,
    BT_ERROR_CODE_DATA_RECIEVE,
    BT_ERROR_CODE_DISCONN_OK,
    BT_ERROR_CODE_VISIBLE_TIMEOUT,
    URC_BT_END
}Enum_BT_ErrorCode;
