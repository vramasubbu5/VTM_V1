...
TASK_ITEM(proc_main_task1, main_task1_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_main_task2, main_task2_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_main_task3, main_task3_id, 10*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_main_task4, main_task4_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_main_task5, main_task5_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_subtask_gpio, subtask_gpio_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
#endif
/**
 ******* TAST CONFIG END ********
 */
