...
#include "ql_uart.h"
#include "ql_gpio.h"
#include "ql_gprs.h"   // added by amruta
 ...
 *
 *                   The URL format for ftp is:   ftp://hostname:password/filePath/fileName:port@username
 *                   NOTE:1. If ":port" is be ignored, it means the port is http default port(21)
 ...
 *
 *                    eg1: ftp://www.jjj.com/filePath/xxx.bin:8021@username:passwerd
 *                    eg2: ftp://www.jjj.com/filePath/xxx.bin@username:passwerd
 ...
 *****************************************************************/
s32 Ql_FOTA_StartUpgrade(u8* url, ST_GprsConfig* apnCfg,
		Callback_Upgrade_State callbcak_UpgradeState_Ind);
